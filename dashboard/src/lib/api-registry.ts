...
export const API_ENDPOINTS: ApiEndpoint[] = [
  ...
  { method: "GET", path: "/api/sync-status", group: "Servers", safe: true, desc: "Live template/overlay file-sync progress (auto file-sync + manual re-sync): per-instance status, overlay size + file count, grouped by node." },
